...
public class SomeUsefulArraysMethods
{
...
// process choice by calling additional methods
            switch(choice)
            {
                ...
                case '6': System.out.println("Array values");
                    ...
                    break;
                case '7':
                    int ave = average(size, someArray);
                    System.out.println("Average of array values = " + ave);
                    break;
            }
        } while (choice != '8');
...
// standard 'for' loop used here as the array index is required
    ...
    static int average (int sizeIn, int... arrayIn)
    {
        int average = 0;
        for (int currentElement : arrayIn)
        {
